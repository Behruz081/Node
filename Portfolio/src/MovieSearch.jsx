...
function MovieSearch() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial' }}>
      ...
      <form onSubmit={searchMovies} style={{display:"flex", gap:"10px", marginBottom:"30px", justifyContent:""}} >
        <input 
          type="text" 
          value={query}
        ...
        <div style={{display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))", gap:"20px"}}>
            {movies.map((movie) => (
                <div
                  ...
                  style={{border:"1px solid #ddd", borderRadius:"10px", cursor:"pointer", overflow:"hidden", textalign:"center", 
                    transition:"0.3s" }}
            ...
            {selectedMovie && (
                <div style={{position:"fixed", top:0, left:0, width:"100%", height:"100%", backgroundColor:"rgba(0,0,0,0.8)", 
                    ...
                    <div style={{backgroundColor:"white", padding:"20px", borderRadius:"15px", maxWidth:"600px", width:"90%", 
